...
Setiap channel penjualan (toko Shopee, TikTok, Tokopedia, Maklon) punya:
  - debit_ar     : akun Piutang yang didebet (1-210 Maklon / 1-220 OS)
...
DA_CHANNELS = [
    # Shopee
    ("shopee_grosirhijabsragen",  "Shopee – Grosirhijabsragen",  "shopee",    "1-220", "4-111"),
    ("shopee_daluna",             "Shopee – Daluna",             "shopee",    "1-220", "4-112"),
    ("shopee_moen",               "Shopee – Moen",               "shopee",    "1-220", "4-113"),
    ("shopee_lainnya",            "Shopee – Lain-lain",          "shopee",    "1-220", "4-114"),
    # TikTok Shop
    ("tiktok_daluna",             "TikTok – Daluna",             "tiktok",    "1-220", "4-121"),
    ("tiktok_outfit_boutique",    "TikTok – Outfit Boutique",    "tiktok",    "1-220", "4-122"),
    ("tiktok_style_by_moen",      "TikTok – Style by Moen",      "tiktok",    "1-220", "4-123"),
    ("tiktok_fatimahijab",        "TikTok – Fatimahijab",        "tiktok",    "1-220", "4-124"),
    ("tiktok_dezza_kids",         "TikTok – Dezza Kids",         "tiktok",    "1-220", "4-125"),
    ("tiktok_lainnya",            "TikTok – Lain-lain",          "tiktok",    "1-220", "4-126"),
    # Tokopedia
    ("tokopedia",                 "Tokopedia",                   "tokopedia", "1-220", "4-131"),
    # Maklon
    ("maklon_snbm",               "Maklon – SnBm (Sablon & Bordir)", "maklon","1-210", "4-210"),
    ("maklon_lainnya",            "Maklon – Klien Lain-lain",    "maklon",    "1-210", "4-220"),
]
...
async def create_channel(request: Request):
    ...
    doc = {
        ...
        "debit_ar": body.get("debit_ar") or "1-220",
