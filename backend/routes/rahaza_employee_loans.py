...
async def disburse_employee_loan(request: Request):
    ...
    Auto-post GL: Dr. Employee Loan Receivable (1-1320) / Cr. Cash (1-110)
    ...
    # Generate loan number (RC-5 fix: atomic race-safe numbering, was count_documents()+1)
    loan_number = await gen_prefixed_number(db, "rahaza_employee_loans", "loan_number", "LOAN-", 5)
