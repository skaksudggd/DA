...
DEFAULT_CASH_CODE = "1-131"          # Bank BCA – DA Official (Online Shop)
DEFAULT_RECEIVABLE_CODE = "1-220"    # Piutang Platform Online Shop
...
COA_ROLE_RULES = {
    ...
    "coa_cash_code": {
        ...
        "hint": "pilih rekening kas/bank/e-wallet (mis. 1-131 Bank BCA – DA Official, 1-154 ShopeePay)",
    },
    "coa_receivable_code": {
        ...
        "lenient": lambda r: r.get("type") == "ASSET",
        "hint": "pilih akun piutang (mis. 1-220 Piutang Platform Online Shop)",
    },
}
...
async def _default_cash_code(db) -> str:
    """Rekening penerima pencairan default (1-131); fallback ke kas/bank pertama."""
    row = await db.rahaza_coa_accounts.find_one(
