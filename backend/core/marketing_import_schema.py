...
MARKETPLACE_ORDERS = SourceType(
    ...
    fields=(
        ...
        # ── item (masuk items[]) ──────────────────────────────────────────────
        Field("platform_sku_id", "SKU ID Platform", "str", True,
              ("sku id", "id sku", "sku"), example="1731234567890123456"),
        Field("seller_sku", "SKU Penjual", "str", False, ("seller sku", "kode sku penjual")),
        ...
        Field("qty_returned", "Jumlah Dikembalikan", "int", False,
              ("sku quantity of return", "qty return")),
        ...
        Field("paid_at", "Waktu Dibayar", "datetime", False, ("paid time",)),
        Field("rts_at", "Waktu Siap Kirim", "datetime", False, ("rts time",)),
        Field("shipped_at", "Waktu Dikirim", "datetime", False, ("shipped time",)),
        Field("delivered_at", "Waktu Diterima", "datetime", False, ("delivered time",)),
        Field("cancelled_at", "Waktu Dibatalkan", "datetime", False, ("cancelled time",)),
        Field("cancel_by", "Dibatalkan Oleh", "str", False, ("cancel by",)),
        Field("cancel_reason", "Alasan Pembatalan", "str", False, ("cancel reason",)),
        # ── pengiriman & kanal ────────────────────────────────────────────────
        ...
        Field("tracking_number", "No. Resi", "str", False, ("tracking id", "tracking number", "resi")),
        Field("delivery_option", "Opsi Pengiriman", "str", False, ("delivery option",)),
        ...
        Field("weight_kg", "Berat (kg)", "num", False, ("weight kg", "weight(kg)", "berat")),
        Field("payment_method", "Metode Bayar", "str", False, ("payment method",)),
        Field("purchase_channel", "Platform Sumber", "str", True,
              ("purchase channel",), example="TikTok",
              note="Harus cocok dengan platform toko tujuan — kalau beda, berkas ditolak"),
        ...
        # ── pembeli & alamat ──────────────────────────────────────────────────
        Field("buyer_username", "Username Pembeli", "str", False, ("buyer username",)),
        Field("customer_name", "Nama Penerima", "str", False, ("recipient", "nama penerima")),
        Field("customer_phone", "Telepon", "str", False, ("phone", "phone #", "no hp")),
        ...
        Field("city", "Kota/Kabupaten", "str", False, ("regency and city", "kota", "city")),
        Field("district", "Kecamatan", "str", False, ("districts", "kecamatan")),
        Field("village", "Kelurahan/Desa", "str", False, ("villages", "kelurahan")),
        Field("address_detail", "Alamat Detail", "str", False, ("detail address", "alamat")),
        Field("address_extra", "Info Alamat Tambahan", "str", False,
              ("additional address information",)),
        Field("buyer_message", "Pesan Pembeli", "str", False, ("buyer message",)),
        Field("seller_note", "Catatan Penjual", "str", False, ("seller note",)),
...
ADS = SourceType(
    ...
    fields=(
        Field("date", "Tanggal", "datetime", True, _DATE_SYN, example="2026-08-01"),
        ...
        Field("campaign_id", "ID Kampanye", "str", False, ("campaign id", "kode kampanye")),
        Field("ad_type", "Jenis Iklan", "enum", False,
              ("tipe iklan", "ad type", "jenis"),
        ...
        Field("clicks", "Klik", "int", False, ("klik", "clicks")),
...
RETURNS = SourceType(
    ...
    identity_label="nomor pesanan",
    fields=(
        Field("date", "Tanggal Retur", "date", True, _DATE_SYN, example="2026-08-01"),
        Field("order_id", "No. Pesanan", "str", True,
              ("order id", "no pesanan", "nomor pesanan", "order sn"),
              example="SHP-2026081001"),
        Field("product", "Produk", "str", True, ("produk", "nama produk")),
        Field("price", "Harga (Rp)", "money", False, ("harga", "nilai")),
        Field("reason", "Alasan", "enum", True, ("alasan", "reason", "penyebab"),
        ...
        Field("reason_detail", "Detail Alasan", "str", False, ("detail", "keterangan")),
