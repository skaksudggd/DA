              ...
              <div className="grid grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="text-foreground font-medium tabular-nums">
                    {viewDialog.roll?.uom === 'kg'
                      ? `${fmt(viewDialog.roll?.remaining_kg)} / ${fmt(viewDialog.roll?.weight_kg)} kg`
                      : `${fmt(viewDialog.roll?.remaining_m)} / ${fmt(viewDialog.roll?.length_m)} ${viewDialog.roll?.uom || 'm'}`}
                  </p>
                </div>
                <div>
